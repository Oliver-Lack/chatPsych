    ...
    def thinkAbout(self, message, conversation, model=None, debug=False):
        ...
        try:
            ...
            try:
                ...
                response = {'choices': [{'message': {'content': "I'm sorry, I'm currently experiencing technical difficulties. Please try again in a moment."}}], 'usage': {'prompt_tokens': 0, 'completion_tokens': 0, 'total_tokens': 0}, 'error_for_logging': e.__str__()}
